 ...
 <div class="container">
  <div class="row">
   <div class="col-md-12">
    ...
    <span class="breadcrumb-part font-5">კეისის ქულერები</span>
   </div>
  </div>
 </div>
</div>
...
@if($contentData['coolersExist'])
<div class="container">
 <div class="row align-items-start">
  <div class="col-sm-3 filter">
   <div id="products-filter-block">
    <div class="block_content filter-item">
     <form action="{{ route('ccLoad') }}" class="filter-form" method="post">
      <div class="filter-form-container">
       ...
       <div class="filter-unit">
        ...
        <ul class="col-lg-12 filter-block-item">
         <div class="input-range price-range" data-min-price="{{ $contentData['configuration']['productPriceRange'] -> caseCoolerMinPrice }}" data-max-price="{{ $contentData['configuration']['productPriceRange'] -> caseCoolerMaxPrice }}">
          <input name="price-from" type="text" class="price-from" oninput="this.value = this.value.replace(/[^0-9.]/g, '')" value="{{ $contentData['configuration']['productPriceRange'] -> caseCoolerMinPrice }}" />
          <input name="price-to" type="text" class="price-to" oninput="this.value = this.value.replace(/[^0-9.]/g, '')" value="{{ $contentData['configuration']['productPriceRange'] -> caseCoolerMaxPrice }}" />
         </div>
       ...
       <!--- Cooler type filter start ---->

       <div class="filter-unit" style="display: none">
        <h2 class="title-block">
         <span class="font-5">სოკეტი</span>
        </h2>
        <ul class="col-lg-12 filter-block-item"></ul>
        <input name="socket" type="hidden" class="socket" value="0" />
       </div>

       <!--- Cooler type filter end ----->

       <!--- Cooler size filter start ---->

       <div class="filter-unit">
        <h2 class="title-block">
         <span class="font-5">ზომა</span>
        </h2>
        <ul class="col-lg-12 filter-block-item">
         @foreach($contentData['configuration']['coolersSizes'] as $key => $value)

         <li class="nomargin hiddable col-lg-12">
          <a href="#" class="checkbox" data-value="{{ $value -> size }}" data-active="0" data-hidden-input="size">
           <b class="font-6">{{ $value -> size }} მმ</b>
        ...
        <input name="size" type="hidden" class="size" value="0" />
       </div>

       <!--- Cooler size filter end ----->
  ...
  <div class="product-list-column col-xs-12 col-sm-9">
   ...
   <div id="result-content" data-products-category-id="{{ $contentData['productsCategoryId'] }}">
    <ul class="product-list grid row">
     @foreach($contentData['coolers'] as $value)
     <li class="ajax-block-product col-md-4" data-product-id="{{ $value -> id }}">
      <div class="product-container">
       <div class="itw-display-product-info">
        <div class="left-block">
         <div class="product-image-container">
          <a target="_blank" href="/caseCoolers/{{ $value -> id }}" title="{{ $value -> title }}">
           <img class="replace-2x img-fluid" src="/images/caseCoolers/main/original/{{ $value -> mainImage }}" width="450" height="478" />
          </a>
        ...
        <div class="right-block">
         <h5>
          <a class="product-name font-7" target="_blank" href="/caseCoolers/{{ $value -> id }}" title="{{ $value -> title }}">
       ...
       <div class="product-more-options">
        <div class="read-more-container">
         <a class="button read-more-button btn btn-secondary" target="_blank" href="/caseCoolers/{{ $value -> id }}">
      ...
      <div id="bottom-pagination" class="clearfix">
       <ul class="pagination">
        ...
        <li class="pagination-previous">
         <a href="/index/caseCoolers/{{ $contentData['currentPage'] - 1 }}" rel="prev">
        ...
        <li>
         <a href="/index/caseCoolers/{{ $page['value'] }}">
          <span>{{ $page['value'] }}</span>
         </a>
        </li>
        ...
        <li class="pagination-next">
         <a href="/index/caseCoolers/{{ $contentData['currentPage'] + 1 }}" rel="next">
