 ...
 <div class="container">
  <div class="row">
   <div class="col-md-12">
    ...
    <span class="breadcrumb-part font-5">SSD მეხსიერება</span>
   </div>
  </div>
 </div>
</div>
  ...
  <div class="col-sm-3 filter">
   <div id="products-filter-block">
    <div class="block_content filter-item">
     <form action="{{ route('ssdLoad') }}" class="filter-form" method="post">
      <div class="filter-form-container">
       ...
       <div class="filter-unit">
        ...
        <ul class="col-lg-12 filter-block-item">
         <div
          ...
          data-min-price="{{ $contentData['configuration']['productPriceRange'] -> solidStateDriveMinPrice }}"
          data-max-price="{{ $contentData['configuration']['productPriceRange'] -> solidStateDriveMaxPrice }}"
         >
       ...
       <div class="filter-unit">
        <h2 class="title-block">
         <span class="font-5">ტექნოლოგია</span>
        </h2>
        <ul class="col-lg-12 filter-block-item">
         @foreach($contentData['configuration']['technologies'] as $key => $value)
         <li class="nomargin hiddable col-lg-12">
          <a href="#" class="checkbox" data-value="{{ $value -> id }}" data-active="0" data-hidden-input="technology-id">
  ...
  <div class="product-list-column col-xs-12 col-sm-9">
   ...
   <div id="result-content" data-products-category-id="{{ $contentData['productsCategoryId'] }}">
    <ul class="product-list grid row">
     @foreach($contentData['solidStateDrives'] as $value)
      ...
      <div class="product-container">
       <div class="itw-display-product-info">
        <div class="left-block">
         <div class="product-image-container">
          <a target="_blank" href="/solidStateDrives/{{ $value -> id }}" title="{{ $value -> title }}">
           <img class="replace-2x img-fluid" src="/images/solidStateDrives/main/original/{{ $value -> mainImage }}" width="450" height="478" />
          </a>
        ...
        <div class="right-block">
         <h5>
          <a class="product-name font-7" target="_blank" href="/solidStateDrives/{{ $value -> id }}" title="{{ $value -> title }}">
       ...
       <div class="product-more-options">
        <div class="read-more-container">
         <a class="button read-more-button btn btn-secondary" target="_blank" href="/solidStateDrives/{{ $value -> id }}">
      ...
      <div id="bottom-pagination" class="clearfix">
       ...
       @if($contentData['currentPage'] > 1)
        ...
        <li class="pagination-previous">
         <a href="/index/solidStateDrives/{{ $contentData['currentPage'] - 1 }}" rel="prev">
        ...
        @else
        <li>
         <a href="/index/solidStateDrives/{{ $page['value'] }}">
          <span>{{ $page['value'] }}</span>
         </a>
        </li>
        @endif
        ...
        <li class="pagination-next">
         <a href="/index/solidStateDrives/{{ $contentData['currentPage'] + 1 }}" rel="next">
