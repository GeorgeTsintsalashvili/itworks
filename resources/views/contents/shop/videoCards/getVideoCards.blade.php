  ...
  <div class="product-container">
   <div class="itw-display-product-info">
    ...
    <div class="right-block">
     <h5>
      <a class="product-name font-7" target="_blank" href="/videoCards/{{ $value -> id }}" title="{{ $value -> title }}">
   ...
   <div class="product-more-options">
    <div class="read-more-container">
     <a class="button read-more-button btn btn-secondary" target="_blank" href="/videoCards/{{ $value -> id }}">
