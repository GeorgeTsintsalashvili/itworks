 ...
 <div class="container">
  <div class="row">
   <div class="col-md-12">
    ...
    <span class="breadcrumb-part font-5">HDD მეხსიერება</span>
   </div>
  </div>
 </div>
</div>
...
@if($contentData['hardDiskDrivesExist'])
<div class="container">
 <div class="row align-items-start">
  <div class="col-sm-3 filter">
   <div id="products-filter-block">
    <div class="block_content filter-item">
     <form action="{{ route('hddLoad') }}" class="filter-form" method="post">
      <div class="filter-form-container">
       ...
       <div class="filter-unit">
        ...
        <ul class="col-lg-12 filter-block-item">
         <div
          ...
          data-min-price="{{ $contentData['configuration']['productPriceRange'] -> hardDiskDriveMinPrice }}"
          data-max-price="{{ $contentData['configuration']['productPriceRange'] -> hardDiskDriveMaxPrice }}"
         >
          <input name="price-from" type="text" class="price-from" oninput="this.value = this.value.replace(/[^0-9.]/g, '')" value="{{ $contentData['configuration']['productPriceRange'] -> hardDiskDriveMinPrice }}" />
          <input name="price-to" type="text" class="price-to" oninput="this.value = this.value.replace(/[^0-9.]/g, '')" value="{{ $contentData['configuration']['productPriceRange'] -> hardDiskDriveMaxPrice }}" />
         </div>
       ...
       <div class="filter-unit">
        ...
        <ul class="col-lg-12 filter-block-item">
         ...
         <li class="nomargin hiddable col-lg-12">
          <a href="#" class="checkbox" data-value="{{ $value -> capacity }}" data-active="0" data-hidden-input="capacity">
       ...
       <div class="filter-unit">
        <h2 class="title-block">
         <span class="font-5">ბრუნვის სიჩქარე</span>
        </h2>
        <ul class="col-lg-12 filter-block-item">
         @foreach($contentData['configuration']['rpm'] as $key => $value)
         <li class="nomargin hiddable col-lg-12">
          <a href="#" class="checkbox" data-value="{{ $value -> rpm }}" data-active="0" data-hidden-input="rpm">
           <b>{{ $value -> rpm }} <span class="font-5"> ბრ/წთ</span></b>
           <span> ({{ $value -> numOfProducts }})</span>
          </a>
         </li>
         @endforeach
        </ul>
        <input name="rpm" type="hidden" class="rpm" value="0" />
       </div>
       ...
       <div class="filter-unit">
        ...
        <ul class="col-lg-12 filter-block-item">
         ...
         <li class="nomargin hiddable col-lg-12">
          <a href="#" class="checkbox" data-value="{{ $value -> id }}" data-active="0" data-hidden-input="form-factor-id">
  ...
  <div class="product-list-column col-xs-12 col-sm-9">
   ...
   <div id="result-content" data-products-category-id="{{ $contentData['productsCategoryId'] }}">
    <ul class="product-list grid row">
     @foreach($contentData['hardDiskDrives'] as $value)
      ...
      <div class="product-container">
       <div class="itw-display-product-info">
        <div class="left-block">
         <div class="product-image-container">
          <a target="_blank" href="/hardDiskDrives/{{ $value -> id }}" title="{{ $value -> title }}">
           <img class="replace-2x img-fluid" src="/images/hardDiskDrives/main/original/{{ $value -> mainImage }}" width="450" height="478" />
          </a>
        ...
        <div class="right-block">
         <h5>
          <a class="product-name font-7" target="_blank" href="/hardDiskDrives/{{ $value -> id }}" title="{{ $value -> title }}">
       ...
       <div class="product-more-options">
        <div class="read-more-container">
         <a class="button read-more-button btn btn-secondary" target="_blank" href="/hardDiskDrives/{{ $value -> id }}">
      ...
      <div id="bottom-pagination" class="clearfix">
       ...
       @if($contentData['currentPage'] > 1)
        ...
        <li class="pagination-previous">
         <a href="/index/hardDiskDrives/{{ $contentData['currentPage'] - 1 }}" rel="prev">
        ...
        <li>
         <a href="/index/hardDiskDrives/{{ $page['value'] }}">
          <span>{{ $page['value'] }}</span>
         </a>
        </li>
        ...
        <li class="pagination-next">
         <a href="/index/hardDiskDrives/{{ $contentData['currentPage'] + 1 }}" rel="next">
