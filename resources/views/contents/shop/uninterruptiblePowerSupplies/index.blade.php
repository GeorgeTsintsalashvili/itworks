 ...
 <div class="container">
  <div class="row">
   <div class="col-md-12">
    ...
    <span class="breadcrumb-part font-5">უწყვეტის კვების წყარო</span>
   </div>
  </div>
 </div>
</div>
...
@if($contentData['uninterruptiblePowerSuppliesExist'])
...
<div class="container">
 <div class="row align-items-start">
  <div class="col-sm-3 filter">
   <div id="products-filter-block">
    <div class="block_content filter-item">
     <form action="{{ route('upsLoad') }}" class="filter-form" method="post">
      <div class="filter-form-container">
       ...
       <div class="filter-unit">
        ...
        <ul class="col-lg-12 filter-block-item">
         <div class="input-range price-range" data-min-price="{{ $contentData['configuration']['productPriceRange'] -> uninterruptiblePowerSupplyMinPrice }}" data-max-price="{{ $contentData['configuration']['productPriceRange'] -> uninterruptiblePowerSupplyMaxPrice }}">
          <input name="price-from" type="text" class="price-from" oninput="this.value = this.value.replace(/[^0-9.]/g, '')" value="{{ $contentData['configuration']['productPriceRange'] -> uninterruptiblePowerSupplyMinPrice }}" />
          <input name="price-to" type="text" class="price-to" oninput="this.value = this.value.replace(/[^0-9.]/g, '')" value="{{ $contentData['configuration']['productPriceRange'] -> uninterruptiblePowerSupplyMaxPrice }}" />
         </div>
       ...
       <div class="filter-unit">
        <h2 class="title-block">
         <span class="font-5">სიმძლავრე</span>
        </h2>
        <ul class="col-lg-12 filter-block-item">
         <div class="input-range">
          <input name="power-from" type="text" class="power-from" oninput="this.value = this.value.replace(/[^0-9.]/g, '')" value="{{ $contentData['configuration']['minPower'] }}" />
          <input name="power-to" type="text" class="power-to" oninput="this.value = this.value.replace(/[^0-9.]/g, '')" value="{{ $contentData['configuration']['maxPower'] }}" />
         </div>
        </ul>
       </div>
  ...
  <!--- UltimatePowerSupplies list start ----->
  ...
  <div class="product-list-column col-xs-12 col-sm-9">
      ...
      <div class="products-sort-select cstm-select closed" tabindex="-2">
       ...
       <div class="cstm-options-container">
        ...
        <div class="cstm-option-item" data-option-value="3">
         <span>სიმძლავრის კლებადობით</span>
        </div>
        <div class="cstm-option-item" data-option-value="4">
         <span>სიმძლავრის ზრდადობით</span>
        </div>
   ...
   <div id="result-content" data-products-category-id="{{ $contentData['productsCategoryId'] }}">
    <ul class="product-list grid row">
     @foreach($contentData['uninterruptiblePowerSupplies'] as $value)
     <li class="ajax-block-product col-md-4" data-product-id="{{ $value -> id }}">
      <div class="product-container">
       <div class="itw-display-product-info">
        <div class="left-block">
         <div class="product-image-container">
          <a target="_blank" href="/uninterruptiblePowerSupplies/{{ $value -> id }}" title="{{ $value -> title }}">
           <img class="replace-2x img-fluid" src="/images/uninterruptiblePowerSupplies/main/original/{{ $value -> mainImage }}" width="450" height="478" />
          </a>
        ...
        <div class="right-block">
         <h5>
          <a class="product-name font-7" target="_blank" href="/uninterruptiblePowerSupplies/{{ $value -> id }}" title="{{ $value -> title }}">
       ...
       <div class="product-more-options">
        <div class="read-more-container">
         <a class="button read-more-button btn btn-secondary" target="_blank" href="/uninterruptiblePowerSupplies/{{ $value -> id }}">
      ...
      <div id="bottom-pagination" class="clearfix">
       ...
       @if($contentData['currentPage'] > 1)
        ...
        <li class="pagination-previous">
         <a href="/index/uninterruptiblePowerSupplies/{{ $contentData['currentPage'] - 1 }}" rel="prev">
        ...
        <li>
         <a href="/index/uninterruptiblePowerSupplies/{{ $page['value'] }}">
          <span>{{ $page['value'] }}</span>
         </a>
        </li>
        ...
        <li class="pagination-next">
         <a href="/index/uninterruptiblePowerSupplies/{{ $contentData['currentPage'] + 1 }}" rel="next">
  ...
  <!--- Ultimate Power Supplies list end ------>
 </div>
 <!-- .row -->
</div>
