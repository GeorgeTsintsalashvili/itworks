 ...
 <div class="container">
  <div class="row">
   <div class="col-md-12">
    ...
    <span class="breadcrumb-part font-5">პროცესორის ქულერები</span>
   </div>
  </div>
 </div>
</div>
...
@if($contentData['processorCoolersExist'])
  ...
  <div class="col-sm-3 filter">
   <div id="products-filter-block">
    <div class="block_content filter-item">
     <form action="{{ route('pcLoad') }}" class="filter-form" method="post">
       ...
       <div class="filter-unit">
        ...
        <ul class="col-lg-12 filter-block-item">
         <div
          ...
          data-min-price="{{ $contentData['configuration']['productPriceRange'] -> processorCoolerMinPrice }}"
          data-max-price="{{ $contentData['configuration']['productPriceRange'] -> processorCoolerMaxPrice }}"
         >
          <input name="price-from" type="text" class="price-from" oninput="this.value = this.value.replace(/[^0-9.]/g, '')" value="{{ $contentData['configuration']['productPriceRange'] -> processorCoolerMinPrice }}" />
          <input name="price-to" type="text" class="price-to" oninput="this.value = this.value.replace(/[^0-9.]/g, '')" value="{{ $contentData['configuration']['productPriceRange'] -> processorCoolerMaxPrice }}" />
         </div>
      ...
      <div id="bottom-pagination" class="clearfix">
       ...
       @if($contentData['currentPage'] > 1)
        ...
        <li class="pagination-previous">
         <a href="/index/processorCoolers/{{ $contentData['currentPage'] - 1 }}" rel="prev">
        ...
        <li>
         <a href="/index/processorCoolers/{{ $page['value'] }}">
          <span>{{ $page['value'] }}</span>
         </a>
        </li>
        ...
        <li class="pagination-next">
         <a href="/index/processorCoolers/{{ $contentData['currentPage'] + 1 }}" rel="next">
