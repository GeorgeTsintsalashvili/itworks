 ...
 <div class="container">
  <div class="row">
   <div class="col-md-12">
    ...
    <span class="breadcrumb-part font-5">პერიფერიალები</span>
   </div>
  </div>
 </div>
</div>
...
@if($contentData['peripheralsExist'])
  ...
  <div class="col-sm-3 filter">
   <div id="products-filter-block">
    <div class="block_content filter-item">
     <form action="{{ route('perLoad') }}" class="filter-form" method="post">
      <div class="filter-form-container">
       ...
       <div class="filter-unit">
        ...
        <ul class="col-lg-12 filter-block-item">
         <div class="input-range price-range" data-min-price="{{ $contentData['configuration']['productPriceRange'] -> peripheralMinPrice }}" data-max-price="{{ $contentData['configuration']['productPriceRange'] -> peripheralMaxPrice }}">
          <input name="price-from" type="text" class="price-from" oninput="this.value = this.value.replace(/[^0-9.]/g, '')" value="{{ $contentData['configuration']['productPriceRange'] -> peripheralMinPrice }}" />
          <input name="price-to" type="text" class="price-to" oninput="this.value = this.value.replace(/[^0-9.]/g, '')" value="{{ $contentData['configuration']['productPriceRange'] -> peripheralMaxPrice }}" />
         </div>
       ...
       <div class="filter-unit">
        ...
        <ul class="col-lg-12 filter-block-item">
         @foreach($contentData['configuration']['peripheralTypes'] as $value)
       ...
       <div id="bottom-pagination" class="clearfix">
        <ul class="pagination">
         ...
         <li class="pagination-previous">
          <a href="/index/peripherals/{{ $contentData['categoryId'] }}/{{ $contentData['currentPage'] - 1 }}" rel="prev">
         ...
         <li>
          <a href="/index/peripherals/{{ $contentData['categoryId'] }}/{{ $page['value'] }}">
           <span>{{ $page['value'] }}</span>
          </a>
         </li>
         ...
         <li class="pagination-next">
          <a href="/index/peripherals/{{ $contentData['categoryId'] }}/{{ $contentData['currentPage'] + 1 }}" rel="next">
