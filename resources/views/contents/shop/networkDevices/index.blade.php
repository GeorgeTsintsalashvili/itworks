 ...
 <div class="container">
  <div class="row">
   <div class="col-md-12">
    ...
    <span class="breadcrumb-part font-5">ქსელური მოწყობილობები</span>
   </div>
  </div>
 </div>
</div>
...
@if($contentData['networkDevicesExist'])
  ...
  <div class="col-sm-3 filter">
   <div id="products-filter-block">
    <div class="block_content filter-item">
     <form action="{{ route('ndLoad') }}" class="filter-form" method="post">
      <div class="filter-form-container">
       ...
       <div class="filter-unit">
        ...
        <ul class="col-lg-12 filter-block-item">
         <div
          ...
          data-min-price="{{ $contentData['configuration']['productPriceRange'] -> networkDeviceMinPrice }}"
          data-max-price="{{ $contentData['configuration']['productPriceRange'] -> networkDeviceMaxPrice }}"
         >
          <input name="price-from" type="text" class="price-from" oninput="this.value = this.value.replace(/[^0-9.]/g, '')" value="{{ $contentData['configuration']['productPriceRange'] -> networkDeviceMinPrice }}" />
          <input name="price-to" type="text" class="price-to" oninput="this.value = this.value.replace(/[^0-9.]/g, '')" value="{{ $contentData['configuration']['productPriceRange'] -> networkDeviceMaxPrice }}" />
         </div>
       ...
       <div class="filter-unit">
        <h2 class="title-block">
         <span class="font-5">ტიპი</span>
        </h2>
        <ul class="col-lg-12 filter-block-item">
         @foreach($contentData['configuration']['networkDevicesTypes'] as $value)
         <li class="nomargin hiddable col-lg-12">
          @if($value -> id == $contentData['categoryId'])

          <a href="#" class="checkbox type-of-checkbox" data-value="{{ $value -> id }}" data-active="1" data-hidden-input="type">
          ...
          <a href="#" class="checkbox type-of-checkbox" data-value="{{ $value -> id }}" data-active="0" data-hidden-input="type">
           <b class="font-6">{{ $value -> typeTitle }}</b>
           <span> ({{ $value -> numOfProducts }})</span>
          </a>
        ...
        <input name="type" type="hidden" class="type" value="{{ $contentData['categoryId'] }}" />
       </div>
       ...
       <div class="filter-unit">
        ...
        <ul class="col-lg-12 filter-block-item">
         ...
         <li class="nomargin hiddable col-lg-12">
          <a href="#" class="checkbox" value="{{ $value -> id }}" data-active="0" data-hidden-input="stock-type">
       ...
       <div class="filter-unit">
        ...
        <ul class="col-lg-12 filter-block-item">
         ...
         <li class="nomargin hiddable col-lg-12">
          <a href="#" class="checkbox" value="{{ $value -> id }}" data-active="0" data-hidden-input="condition">
  ...
  <div class="product-list-column col-xs-12 col-sm-9">
   ...
   <div id="result-content" data-products-category-id="{{ $contentData['productsCategoryId'] }}">
    <ul class="product-list grid row">
     @foreach($contentData['networkDevices'] as $value)
     <li class="ajax-block-product col-md-4" data-product-id="{{ $value -> id }}">
      <div class="product-container">
       <div class="itw-display-product-info">
        <div class="left-block">
         <div class="product-image-container">
          <a target="_blank" href="/networkDevices/{{ $value -> id }}" title="{{ $value -> title }}">
           <img class="replace-2x img-fluid" src="/images/networkDevices/main/original/{{ $value -> mainImage }}" width="450" height="478" />
          </a>
        ...
        <div class="right-block">
         <h5>
          <a class="product-name font-7" target="_blank" href="/networkDevices/{{ $value -> id }}" title="{{ $value -> title }}">
       ...
       <div class="product-more-options">
        <div class="read-more-container">
         <a class="button read-more-button btn btn-secondary" target="_blank" href="/networkDevices/{{ $value -> id }}">
      ...
      <div id="bottom-pagination" class="clearfix">
       <ul class="pagination">
        ...
        <li class="pagination-previous">
         <a href="/index/networkDevices/{{ $contentData['categoryId'] }}/{{ $contentData['currentPage'] - 1 }}" rel="prev">
        ...
        <li>
         <a href="/index/networkDevices/{{ $contentData['categoryId'] }}/{{ $page['value'] }}">
          <span>{{ $page['value'] }}</span>
         </a>
        </li>
        ...
        <li class="pagination-next">
         <a href="/index/networkDevices/{{ $contentData['categoryId'] }}/{{ $contentData['currentPage'] + 1 }}" rel="next">
