...
<div class="part-select-head">
  <h1 class="font-6"> პროცესორის გამაგრილებლები </h1>
  ...
  <div class="part-select-body">
   <div class="part-select-list container">
     ...
     <div class="row parts-item">
      <div class="col-sm-2">
        <img src="/images/processorCoolers/main/original/{{ $part -> mainImage }}" class="part-image">
      </div>
      <div class="col-sm-7">
       <div class="part-to-select-container">
         ...
         <div class="part-to-select-description">
           ...
           <div class="part-specification">
            ...
            <div class="part-specification">
              <b class="font-6">ზომა </b>
              <span> {{ $part -> size }} mm</span>
            </div>
      ...
      <div class="col-sm-3">
        ...
        <div class="part-choose-button-container" data-part-id="{{ $part -> id }}" data-part-select-uri="/configurator/selectProcessorCooler">
