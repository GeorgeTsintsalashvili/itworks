...
<div class="part-select-head">
  ...
  <div class="part-select-body">
   <div class="part-select-list container">
     ...
     <div class="row parts-item">
      ...
      <div class="col-sm-3">
        ...
        <div class="part-choose-button-container" data-part-id="{{ $product -> id }}" data-part-select-uri="/configurator/selectComputerMouse">
   ...
   @else
    <h1 class="font-4 component-not-found-heading"> <i class="fa fa-exclamation-triangle"></i> მაუსები ვერ მოიძებნა</h1>
   @endif
