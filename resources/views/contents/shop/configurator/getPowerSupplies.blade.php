...
<div class="part-select-head">
  <h1 class="font-6"> კვების ბლოკები </h1>
  ...
  <div class="part-select-body">
   <div class="part-select-list container">
     ...
     <div class="row parts-item">
      <div class="col-sm-2">
        <img src="/images/powerSupplies/main/original/{{ $part -> mainImage }}" class="part-image">
      </div>
      <div class="col-sm-7">
      ...
      <div class="col-sm-3">
        ...
        <div class="part-choose-button-container" data-part-id="{{ $part -> id }}" data-part-select-uri="/configurator/selectPowerSupply">
