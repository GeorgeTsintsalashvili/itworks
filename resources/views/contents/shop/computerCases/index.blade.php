 ...
 <div class="container">
  <div class="row">
   <div class="col-md-12">
    ...
    <span class="breadcrumb-part font-5">კეისები</span>
   </div>
  </div>
 </div>
</div>
   ...
   <div class="col-sm-3 filter">
    <div id="products-filter-block">
     <div class="block_content filter-item">
      <form action="{{ route('casesLoad') }}" class="filter-form" method="post">
        ...
        <div class="filter-unit">
         ...
         <ul class="col-lg-12 filter-block-item">
          <div
           ...
           data-min-price="{{ $contentData['configuration']['productPriceRange'] -> computerCaseMinPrice }}"
           data-max-price="{{ $contentData['configuration']['productPriceRange'] -> computerCaseMaxPrice }}"
          >
           <input name="price-from" type="text" class="price-from" oninput="this.value = this.value.replace(/[^0-9.]/g, '')" value="{{ $contentData['configuration']['productPriceRange'] -> computerCaseMinPrice }}" />
           <input name="price-to" type="text" class="price-to" oninput="this.value = this.value.replace(/[^0-9.]/g, '')" value="{{ $contentData['configuration']['productPriceRange'] -> computerCaseMaxPrice }}" />
          </div>
         ...
         <ul class="col-lg-12 filter-block-item">
          ...
          <li class="nomargin hiddable col-lg-12">
           <a href="#" class="checkbox" data-value="{{ $value -> id }}" data-active="0" data-hidden-input="form-factor">
            <b class="font-6">{{ $value -> formFactorTitle }}</b>
   ...
   <div class="product-list-column col-xs-12 col-sm-9">
    ...
    <div id="result-content" data-products-category-id="{{ $contentData['productsCategoryId'] }}">
     <ul class="product-list grid row">
      @foreach($contentData['cases'] as $value)
      <li class="ajax-block-product col-md-4" data-product-id="{{ $value -> caseId }}" data-stock-type-id="{{ $value -> stockTypeId }}" data-product-title="{{ $value -> title }}" data-product-price="{{ $value -> newPrice }}">
       <div class="product-container">
        <div class="itw-display-product-info">
         <div class="left-block">
          <div class="product-image-container">
           <a target="_blank" href="/computerCases/{{ $value -> caseId }}" title="{{ $value -> title }}">
            <img class="replace-2x img-fluid" src="/images/computerCases/main/original/{{ $value -> mainImage }}" width="450" height="478" />
           </a>
         ...
         <div class="right-block">
          <h5>
           <a class="product-name font-7" target="_blank" href="/computerCases/{{ $value -> caseId }}" title="{{ $value -> title }}">
        ...
        <div class="product-more-options">
         <div class="read-more-container">
          <a class="button read-more-button btn btn-secondary" target="_blank" href="/computerCases/{{ $value -> caseId }}">
       ...
       <div id="bottom-pagination" class="clearfix">
        ...
        @if($contentData['currentPage'] > 1)
         ...
         <li class="pagination-previous">
          <a href="/index/computerCases/{{ $contentData['currentPage'] - 1 }}" rel="prev">
         ...
         <li>
          <a href="/index/computerCases/{{ $page['value'] }}">
           <span>{{ $page['value'] }}</span>
          </a>
         </li>
         ...
         <li class="pagination-next">
          <a href="/index/computerCases/{{ $contentData['currentPage'] + 1 }}" rel="next">
