 ...
 <div class="panel-body">
  ...
  <div class="tab-content">
    ...
    <div class="tab-pane active" id="editor">
      ...
      <form class="form-horizontal record-update-form" method="POST" action="{{ route('psUpdate') }}">
  ...
  <div class="tab-pane" id="images">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="tab-content">
          <div class="row mb50">
            <div class="col-sm-4">
              <a href="/powerSupplies/{{ $product -> id }}" target="_blank">
               <img id="main-image" src="/images/powerSupplies/main/original/{{ $product -> mainImage }}" class="img-responsive img-thumbnail wpr-100">
            ...
            <div class="col-sm-8">
              <form method="POST" action="{{ route('psImageUpdate') }}" class="dropzone" id="main-image-dropzone" enctype="multipart/form-data">
                <div class="fallback">
    ...
    <div class="panel panel-default">
      ...
      <div class="tab-content">
         ...
         <div class="col-md-12">
             <div class="owl-carousel owl-theme">
               @foreach($images as $image)
                <div class="item">
                  <a href="/images/powerSupplies/slides/original/{{ $image -> image }}" data-fancybox-group="button" class="fancy fancybox-buttons zoom-button">
                    <i class="fas fa-expand"></i>
                  </a>
                  <a href="{{ route('psImgDestroy', ['id' => $image -> id]) }}" class="image-delete-button">
                    <i class="fas fa-trash-alt"></i>
                  </a>
                  <img src="/images/powerSupplies/slides/preview/{{ $image -> image }}">
                </div>
               @endforeach
             </div>
         </div>
        ...
        <div class="row mt40">
          <div class="col-md-12">
            <form method="POST" action="{{ route('psImageUpload') }}" class="dropzone" enctype="multipart/form-data" id="images-dropzone">
            </form>
          </div>
        </div>
