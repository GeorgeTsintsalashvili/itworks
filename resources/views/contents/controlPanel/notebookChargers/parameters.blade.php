	...
	<div class="col-xs-8">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<table class="table table-hover mb1" data-update-route="{{ route('ncmUpdate') }}">
					<thead>
						<tr class="font-6">
							<th>დასახელება</th>
							<th>წაშლა</th>
          ...
          @foreach($manufacturers as $value)
              ...
              <!--- Delete button --->
							<td>
								<a class="delete-record" href="{{ route('ncmDestroy', ['id' => $value -> id]) }}">
        ...
        <div data-page-key="{{ $ncmPageKey }}" data-current-page="{{ $ncmPaginator -> currentPage }}" class="clearfix pagination-column col-sm-12">

          <ul class="pagination mt0 mb20 col-sm-8">

              @if($ncmPaginator -> currentPage > 1)

               <li>
                <a href="{{ $ncmPaginator -> currentPage - 1 }}" class="page-switch">
              ...
              @foreach($ncmPaginator -> pages as $page)
              ...
              @if($ncmPaginator -> currentPage < $ncmPaginator -> maxPage)
       ...
       <form action="{{ route('ncmStore') }}" method="post" class="form-horizontal row-border data-form" enctype="multipart/form-data">
