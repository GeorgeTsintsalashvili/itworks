	...
	<div class="col-xs-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4 class="font-6 p-abs">ვიდეო ბარათები</h4>
				<div class="options">
			...
			<div class="panel-body">
				...
				<div class="tab-content">
				 ...
				 <div class="tab-pane active" id="products-list">
					 ...
					 <table class="table table-hover mb1" data-update-route="{{ route('vcUpdateBase') }}">
	 					<thead>
	 						<tr class="font-6">
	 							<th>სურათი</th>
	 							<th>სათაური</th>
	           ...
	           @foreach($items as $value)
	 						...
	 						<tr data-record-id="{{ $value -> id }}">
	 							...
	 							<td class="preview-image">
	 								<img src="/images/videoCards/main/preview/{{ $value -> mainImage }}" class="invoice-image" data-uuid="f19-{{ $value -> id }}">
	 							</td>
								...
								<td class="text-center">
									<a class="add-warranty mr20" href="f19-{{ $value -> id }}" data-system-part="0" data-warranty-page="parts" data-warranty="{{ $value -> warranty }}" style="line-height: 1">
									 <i style="font-size: 22px" class="fa fa-wrench"></i>
									</a>

								 <a class="add-warranty" href="f19-{{ $value -> id }}" data-system-part="1" data-warranty-page="computer" data-warranty="{{ $value -> warranty }}" style="line-height: 1">
								...
								<td class="text-center">
	 							...
	 							<td class="text-center">
	 							 <a class="view-page" href="{{ route('vcEdit', ['id' => $value -> id]) }}">
	 								<i style="font-size: 18px" class="fas fa-edit" aria-hidden="true"></i>
	 							 </a>
	 							</td>

	 							<td class="text-center">
	 								<a class="delete-record" href="{{ route('vcDestroy', ['id' => $value -> id]) }}">
	         ...
	         <div data-page-key="{{ $paginationKey }}" data-current-page="{{ $paginator -> currentPage }}" class="clearfix pagination-column col-sm-12">
	           ...
	           <div class="col-sm-3">
	             ...
	             <option class="font-6" value="0">ყველა ბრენდი</option>
	              @foreach($manufacturers as $manufacturer)
	                <option value="{{ $manufacturer -> id }}" {{ $selectedManufacturerId == $manufacturer -> id ? "selected" : null }} class="font-6"> {{ $manufacturer -> videoCardManufacturerTitle }} </option>
	              @endforeach
	           </select>
	           ...
	           <ul class="pagination mt0 mb20 col-sm-5">
				 ...
				 <div class="tab-pane" id="add-product">
					 ...
					 <form action="{{ route('vcStore') }}" method="POST" class="form-horizontal row-border store-form" enctype="multipart/form-data">
  			       ...
  			       <input type="text" id="touchspin1" name="price" class="form-control font-7">
 						...
 						<div class="form-group">
							...
							<div class="col-sm-2">
								<input type="text" class="form-control font-7" data-reg-exp="^([1-9]\d*)$" name="minPower">
							</div>

							<label class="col-sm-1 control-label font-6">ინტერფეისი</label>
 							<div class="col-sm-2">
 								<input type="text" class="form-control font-7" data-reg-exp="^([1-9]\d*)$" name="memoryBandwidth">
 							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<select name="videoCardManufacturerId" class="form-select wpr-100">
							...
							<div class="col-sm-2">
								<select name="gpuManufacturerId" class="form-select wpr-100">
									@foreach($graphicalProcessors as $value)
										<option class="font-6" value="{{ $value -> id }}">{{ $value -> gpuTitle }}</option>
									@endforeach
								</select>
							</div>

							<label class="col-sm-1 control-label font-6">VRAM ტიპი</label>
							<div class="col-sm-2">
