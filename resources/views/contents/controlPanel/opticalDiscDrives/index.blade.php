	...
	<div class="col-xs-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4 class="font-6 p-abs">ოპტიკური დისკმძრავები</h4>
				<div class="options">
			...
			<div class="panel-body">
				...
				<div class="tab-content">
				 ...
				 <div class="tab-pane active" id="products-list">
					 ...
					 <table class="table table-hover mb1" data-update-route="{{ route('oddUpdateBase') }}">
	 					<thead>
	 						<tr class="font-6">
	 							<th>სურათი</th>
	 							<th>სათაური</th>
	           ...
	           @foreach($items as $value)
	 						...
	 						<tr data-record-id="{{ $value -> id }}">
	 							...
	 							<td class="preview-image">
	 								<img src="/images/opticalDiscDrives/main/preview/{{ $value -> mainImage }}" class="invoice-image" data-uuid="f12-{{ $value -> id }}">
	 							</td>
								...
								<td class="text-center">
									<a class="add-warranty mr20" href="f12-{{ $value -> id }}" data-system-part="0" data-warranty-page="parts" data-warranty="{{ $value -> warranty }}" style="line-height: 1">
									 <i style="font-size: 22px" class="fa fa-wrench"></i>
									</a>

								 <a class="add-warranty" href="f12-{{ $value -> id }}" data-system-part="0" data-warranty-page="computer" data-warranty="{{ $value -> warranty }}" style="line-height: 1">
	 							...
	 							<td class="text-center">
	 							 <a class="view-page" href="{{ route('oddEdit', ['id' => $value -> id]) }}">
	 								<i style="font-size: 18px" class="fas fa-edit" aria-hidden="true"></i>
	 							 </a>
	 							</td>

	 							<td class="text-center">
	 								<a class="delete-record" href="{{ route('oddDestroy', ['id' => $value -> id]) }}">
	         ...
	         <div data-page-key="{{ $paginationKey }}" data-current-page="{{ $paginator -> currentPage }}" class="clearfix pagination-column col-sm-12">
	           ...
	           <ul class="pagination mt0 mb20 col-sm-5">
				 ...
				 <div class="tab-pane" id="add-product">
					 ...
					 <form action="{{ route('oddStore') }}" method="POST" class="form-horizontal row-border store-form" enctype="multipart/form-data">
  			       ...
  			       <input type="text" id="touchspin1" name="price" class="form-control font-7">
 						...
 						<div class="form-group">
							...
							<label class="col-sm-1 control-label font-6">ტიპი</label>
 							<div class="col-sm-2">
 								<select name="oddTypeId" class="form-select wpr-100">
