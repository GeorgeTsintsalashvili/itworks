	...
	<div class="col-xs-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4 class="font-6 p-abs">ოპერატიული მეხსიერების მოდულები</h4>
				<div class="options">
			...
			<div class="panel-body">
				...
				<div class="tab-content">
				 ...
				 <div class="tab-pane active" id="products-list">
					 ...
					 <table class="table table-hover mb1" data-update-route="{{ route('mmUpdateBase') }}">
	 					<thead>
	 						<tr class="font-6">
	 							<th>სურათი</th>
	 							<th>სათაური</th>
	           ...
	           @foreach($items as $value)
	 						...
	 						<tr data-record-id="{{ $value -> id }}">
	 							...
	 							<td class="preview-image">
	 								<img src="/images/memoryModules/main/preview/{{ $value -> mainImage }}" class="invoice-image" data-uuid="f7-{{ $value -> id }}">
	 							</td>
								...
								<td class="text-center">
									<a class="add-warranty mr20" href="f7-{{ $value -> id }}" data-system-part="0" data-warranty-page="parts" data-warranty="{{ $value -> warranty }}" style="line-height: 1">
									 <i style="font-size: 22px" class="fa fa-wrench"></i>
									</a>

								 <a class="add-warranty" href="f7-{{ $value -> id }}" data-system-part="1" data-warranty-page="computer" data-warranty="{{ $value -> warranty }}" style="line-height: 1">
								...
								<td class="text-center">
	 							...
	 							<td class="text-center">
	 							 <a class="view-page" href="{{ route('mmEdit', ['id' => $value -> id]) }}">
	 								<i style="font-size: 18px" class="fas fa-edit" aria-hidden="true"></i>
	 							 </a>
	 							</td>

	 							<td class="text-center">
	 								<a class="delete-record" href="{{ route('mmDestroy', ['id' => $value -> id]) }}">
	         ...
	         <div data-page-key="{{ $paginationKey }}" data-current-page="{{ $paginator -> currentPage }}" class="clearfix pagination-column col-sm-12">
	           ...
	           <div class="col-sm-4">
	             <div class="input-group">
	               ...
	               <input id="search-field" type="text" autocomplete="off" data-control-parameter-name="search-query" value="{{ $searchQuery }}" class="form-control font-7 control-field" placeholder="საძიებო სიტყვა">
	 					...
	 					<select class="control-data-list col-sm-2 p-n mr20" data-control-parameter-name="{{ $typesKey }}">
	             <option class="font-6" value="0">ყველა ტიპი</option>
	              @foreach($types as $type)
	                <option value="{{ $type -> id }}" {{ $selectedTypeId == $type -> id ? "selected" : null }} class="font-6"> {{ $type -> typeTitle }} </option>
	              @endforeach
	           </select>
	           ...
	           <ul class="pagination mt0 mb20 col-sm-5">
				 ...
				 <div class="tab-pane" id="add-product">
					 ...
					 <form action="{{ route('mmStore') }}" method="POST" class="form-horizontal row-border store-form" enctype="multipart/form-data">
  			       ...
  			       <input type="text" id="touchspin1" name="price" class="form-control font-7">
 						...
 						<div class="form-group">
							...
							<div class="col-sm-2">
									<input type="text" name="quantity" data-reg-exp="^(0|[1-9]\d*)$" class="form-control font-7">
							</div>

							<label class="col-sm-1 control-label font-6">ჯგუფში</label>
							<div class="col-sm-2">
									<input type="text" value="1" name="unitsInGroup" data-reg-exp="^(0|[1-9]\d*)$" class="form-control font-7">
							</div>

							<label class="col-sm-1 control-label font-6">მოცულობა</label>
							<div class="col-sm-2">
								<input type="text" name="capacity" data-reg-exp="^([1-9]\d*)$" class="form-control font-7">
							</div>

							<label class="col-sm-1 control-label font-6">სიხშირე</label>
							<div class="col-sm-2">
								<input type="text" name="frequency" data-reg-exp="^([1-9]\d*)$" class="form-control font-7">
							</div>
						...
						<div class="form-group">
							...
							<label class="col-sm-1 control-label font-6">დანიშნულება</label>
              <div class="col-sm-2">
                <select name="destination" class="form-select wpr-100">
                  <option selected class="font-6" value="2">ნოუთბუქის</option>
                  <option class="font-6" value="1">სტაციონალურის</option>
                </select>
             </div>

							<label class="col-sm-1 control-label font-6">ტიპი</label>
							<div class="col-sm-2">
									<select name="memoryModuleTypeId" class="form-select wpr-100">
