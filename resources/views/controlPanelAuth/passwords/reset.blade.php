...
<div class="content-wrapper">
 ...
 <section id="form-section">
  <div class="form-wrapper">
     <form id="reset-form" method="POST" action="{{ route('password.update') }}" autocomplete="off" data-redirect="{{ route('controlPanelHome') }}">
       ...
       <div class="input-wrapper">
        ...
        <input type="text" class="form-input font-8" name="email" placeholder="ელ. ფოსტა" value="{{ $email }}"/>
       </div>
       <div class="input-wrapper">
        <i class="fas fa-lock" aria-hidden="true"></i>
        <input type="password" class="form-input font-8" name="password" placeholder="ახალი პაროლი"/>
       </div>
       <div class="input-wrapper">
        <i class="fas fa-lock" aria-hidden="true"></i>
        <input type="password" class="form-input font-8" name="password_confirmation" placeholder="გაიმეორეთ პაროლი"/>
       </div>
       <div class="errors-wrapper hidden"></div>
       <div class="control-wrapper">
        <a href="{{ route('password.request') }}">
         <i class="fas fa-sign-in-alt"></i>
         <span class="font-6"> იმეილის შეყვანის ფორმა </span>
        </a>
       </div>
       <div class="submit-button-wrapper">
        <input class="submit-button font-6" type="submit" value="პაროლის შეცვლა" name="register">
       </div>
     </form>
  </div>
 </section>
