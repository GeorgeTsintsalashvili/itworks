...
class StoreVideoCardRequest extends FormRequest
{
  /**
  ...
  */
    ...
    public function rules()
    {
      return [
        ...
        'memoryBandwidth' => ['bail', 'required', new NaturalNumber],
        'minPower' => ['bail', 'required', new NaturalNumber],
        'gpuManufacturerId' => ['bail', 'required', new NaturalNumber],
        'memoryTypeId' => ['bail', 'required', new NaturalNumber],
        'videoCardManufacturerId' => ['bail', 'required', new NaturalNumber]
      ];
    }
}
