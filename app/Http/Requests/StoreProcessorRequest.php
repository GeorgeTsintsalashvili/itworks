  ...
  */
    ...
    public function rules()
    {
      return [
        ...
        'technologyProcessId' => ['bail', 'required', new NaturalNumber],
        'seriesId' => ['bail', 'required', new NaturalNumber],
        'clockSpeed' => ['bail', 'required', new DecimalNumber],
        'cores' => ['bail', 'required', new NaturalNumber],
        'chipsetId' => ['bail', 'required', 'regex:/^\d+(\,\d+)*$/']
      ];
    }
}
