  ...
  */
    ...
    public function rules()
    {
      return [
        ...
        'configuratorPart' => ['bail', 'string', 'nullable'],
        'socketId' => ['bail', 'required', new NaturalNumber],
        'manufacturerId' => ['bail', 'required', new NaturalNumber],
        'memoryTypeId' => ['bail', 'required', new NaturalNumber],
        'chipsetId' => ['bail', 'required', new NaturalNumber],
        'formFactorId' => ['bail', 'required', new NaturalNumber],
        'maxMemory' => ['bail', 'required', new NaturalNumber],
        'ramSlots' => ['bail', 'required', new NaturalNumber],
        'solidStateDriveTypeId' => ['bail', 'required', 'regex:/^\d+(\,\d+)*$/']
      ];
    }
}
