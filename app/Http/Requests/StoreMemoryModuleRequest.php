...
class StoreMemoryModuleRequest extends FormRequest
{
  /**
  ...
  */
    ...
    public function rules()
    {
      return [
        ...
        'memoryModuleTypeId' => ['bail', 'required', new NaturalNumber],
        'capacity' => ['bail', 'required', new NaturalNumber],
        'frequency' => ['bail', 'required', new NaturalNumber],
        'unitsInGroup' => ['bail', 'required', new NaturalNumber],
        'destination' => ['bail', 'required', new NaturalNumber]
      ];
    }
}
